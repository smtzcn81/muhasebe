...
// Kolonlar: Resim + db başlıkları + işlemler/pdf/dxf/x_t
$kolonlar = array_merge(
    [["Resim", "resim"]],
    array_map(function($k){ return [strtoupper(str_replace('_',' ',$k)), $k]; }, $db_kolonlar),
...
<head>
    <meta charset="UTF-8">
    <title>Ürün Listesi (Otomatik Tüm Sütunlar)</title>
...
$(document).ready(function() {
    ...
    document.querySelectorAll('.col-filter').forEach(function(input, colIdx) {
    ...
    // TableDragger: sürükle-bırak kolon (tam uyumlu!)
    ...
    (function(){
        ...
        $c.on("mousedown",function(e){
            down=true;startX=e.pageX;scrollLeft=this.scrollLeft;$(this).addClass("dragging");
        });
        $(document).on("mouseup",function(){down=false;$c.removeClass("dragging");});
